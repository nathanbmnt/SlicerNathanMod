...
If you are new to NathanCustomApp development and you don't have push access to the NathanCustomApp
...
When submitting a PR, make sure to add a `Cc: @NathanCustomApp/developers` comment to
notify NathanCustomApp developers of your awesome contributions. Based on the
...
[pr]: https://github.com/Nathan Corp/NathanCustomApp/merge_requests
[is]: https://github.com/Nathan Corp/NathanCustomApp/issues
